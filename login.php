...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="en"> <!--<![endif]-->
    ...
    <body>
                    ...
                    <div class="block block-themed animated fadeIn">
                        <div class="block-header bg-success">
                            <ul class="block-options">
                                ...
                                <li>
                                    <a href="http://comments.cgr" data-toggle="tooltip" data-placement="left" title="Вернуться к отзывам"><i class="si si-login"></i></a>
                                </li>
                            </ul>
                        ...
                        <div class="block-content block-content-full block-content-narrow">
                            ...
                            <p>Пожалуйста заполните поля чтоб оставить отзыв.</p>
                            <!-- END Register Title -->

                            <!-- Register Form -->
                            <!-- jQuery Validation (.js-validation-register class is initialized in js/pages/base_pages_register.js) -->
                            <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
                            <form class="js-validation-register form-horizontal push-50-t push-50" action="/" method="post" name="link">
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="form-material form-material-success">
                                            <textarea required class="form-control" type="material-text" rows="6" id="text" name="text" placeholder="Please enter a text"></textarea>
                                            <label for="register-username">Text</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="form-material form-material-success">
                                            <input class="form-control" type="email" id="register-email" name="homepage" placeholder="Please provide your homepage">
                                            <label for="register-email">HomePage</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="g-recaptcha" data-sitekey="6LdyGo0UAAAAAIJ2okVppDkj7sn2SsYon61UEz4e"></div>
        ...
        <script src='https://www.google.com/recaptcha/api.js?render=6LdiE40UAAAAAOUMYaTeADUQ1fNgOfD7p12yE0Cn'></script>
        <!-- Page JS Plugins -->
